    ...
    LoginComponent.prototype.login = function (e) {
        ...
        this.AuthService.login(data).then(function (res) {
            ...
            _this.AuthService.getUser()
                ...
                _this.hideLoading();
                _this.router.navigate(['cadastro/secretfriend']);
            });
        }).catch(function () {
            _this.hideLoading();
        });
...
var AuthService = (function (_super) {
    ...
    AuthService.prototype.builder = function (resource) {
        ...
        return _super.prototype.builder.call(this, 'admin/' + resource);
    };
    ...
    AuthService.prototype.registry = function (data) {
        var _this = this;
        var observable = this.http.post(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].server_url + '/registry', data);
        return this.toPromise(observable).then(function (res) {
            _this.eventEmitter.emit();
            return res;
        });
