    ...
    EditComponent.prototype.save = function (e) {
        ...
        if (this.user.name != null && this.user.name.length > 4
            ...
            this.httpService.builder('users')
                ...
                _this.hideLoading();
                _this.toasterService.message('Sucesso', 'Usuário salvo com sucesso', 'success');
                _this.close();
            });
        }
        else {
